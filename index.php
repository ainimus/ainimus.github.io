...
<!-- Mirrored from tamzidhossain.info/html/obligue-online/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Apr 2018 08:01:12 GMT -->
<head>
        <!-- ========== PAGE TITLE ========== -->
        <title>Obligue-Personal Responsive Bootstrap Template</title>
        <!-- ========== META TAGS ========== -->
    ...
    <body>
        ...
        <!-- ========== MENUBAR ========== -->
        <div class="box">
            <div class="option"><i class="fa fa-cog fa-spin fa-2x" aria-hidden="true"></i></div>
                            ...
                            <div class="col-md-10 col-sm-10 navbar-style">
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li>
                                            <a href="www.themeforest.html">Buy Now</a>
                                        </li>
                                    </ul><!-- end nav -->
                                    ...
                                    <div class="home-text wow fadeIn text-center">
                                        <div class="about-social-icon text-center">
                                            <ul class="about-social"> 
                                                ...
                                                <li><a href="www.linkedin.html" target="newtab"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                                <li><a href="www.behance.html" target="newtab"><i class="fa fa-behance" aria-hidden="true"></i></a></li>
                                                <li><a href="www.instagram.html" target="newtab"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                            </ul>
                                        </div><!-- end about-social-icon -->
                                        <h2>Designer</h2>
                                        <a href="#contact.html" class="hvr-bounce-to-right leftbutt">Contact Me</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12 about-col">
                                    <div class="about-details">
                                        ...
                                        <a href="#contact.html" class="hvr-bounce-to-right leftbutt colorbutton">Contact Me</a>
                            ...
                            <div class="row main-row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="service-details">
                                        <div class="service1-hover"></div>
                                        <div class="media">
                                            <i class="fa fa-car service-icon" aria-hidden="true"></i>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="service-details">
                                        <div class="service1-hover"></div>
                                        <div class="media">
                                            <i class="fa fa-television service-icon" aria-hidden="true"></i>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="post-slide">
                                            ...
                                            <div class="post-content">
                                                ...
                                                <ul class="post-bar">
                                                    <li><i class="fa fa-calendar"></i> Mar 15, 2016</li>
                                                    <li>
        ...
        <script src="js/jquery.fancybox-buttons3447.js?v=1.0.5"></script>
        <script src="js/jquery.fancybox-thumbsf2ad.js?v=1.0.7"></script>
...
<!-- Mirrored from tamzidhossain.info/html/obligue-online/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Apr 2018 08:01:58 GMT -->
</html><!-- end html -->
